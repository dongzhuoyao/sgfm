...
def main(
    ...
    feat_h5_path = "~/lab/sgfm/assets/datasets/imagenet100_256_features.h5"
    if debug:
    ...
    in100_list = "~/lab/sgfm/scripts/imagenet100.txt"
    in100_list = Path(in100_list).expanduser().resolve()

    dataset = ImageNet100(
        path=ds_path,
        in100_list=in100_list,
